...
The MutationHistogram class has been moved to rna_map_mini.analysis.mutation_histogram.
Statistical functions have been moved to rna_map_mini.analysis.statistics.
Plotting functions have been moved to rna_map_mini.visualization.
...
from rna_map_mini.analysis.statistics import (
    get_dataframe,
    merge_all_merge_mut_histo_dicts,
    merge_mut_histo_dicts,
)
from rna_map_mini.visualization import (
    colors_for_sequence,
    plot_modified_bases,
