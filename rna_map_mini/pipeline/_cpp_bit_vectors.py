...
from rna_map_mini.io.sam import AlignedRead
from rna_map_mini.io.fasta import fasta_to_dict
from rna_map_mini.io.fastq import parse_phred_qscore_file
from rna_map_mini import settings
...
def generate_bit_vectors_cpp(
    ...
    from rna_map_mini.io.sam import SingleSamIterator, PairedSamIterator
    from rna_map_mini.core.bit_vector import BitVector
    ...
    from rna_map_mini.pipeline.bit_vector_generator import BitVectorGenerator
